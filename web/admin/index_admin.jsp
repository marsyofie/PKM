...
<% 
idd1=request.getParameter("id_dok");
if(idd1!=null)
...
String sqlPagination="SELECT SQL_CALC_FOUND_ROWS * FROM rs_dokter order by id_dokter DESC limit "+iPageNo+","+iShowRows+"";
...
{
    id_dok=rsPagination.getInt("id_dokter");
%>
<tr>
<td align="right"><%=rsPagination.getInt("id_dokter")%></td>
<td><%=rsPagination.getString("nama_dokter")%></td>
<td><%=rsPagination.getString("spesialis")%></td>
<td><%=rsPagination.getString("alamat_dr")%></td>
<td><%=rsPagination.getString("username_dr")%></td>
<td><a href="edit.jsp?id_dok=<%=id_dok%>">Edit</a></td>
<td><a href="index_admin.jsp?del=yes&id_dok=<%=id_dok%>" onclick="return del()">Delete</a></td>
</tr>
<%
}
%>
