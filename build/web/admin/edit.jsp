...
<div class="left">
    Welcome <b><%=session.getAttribute("userid")%></b><br><br>
                           <ul>
                               ...
                               <li class="btn"><a href="search_admin.jsp"/>Search </a></li>
...
<form action="update.jsp" method="post">
    <div align="center"><table>
        <tr>
            <td>ID</td>
            <td><input type="text" name="id_d" value="<%=id_d%>" readonly></td>
        </tr>
        <tr>
            <td>Nama</td>
        ...
        <tr>
            <td>Spesialis</td>
            <td><input type="text" name="spesialis" value="<%=spesialis%>"></td>
        </tr>
        <tr>
            <td>Alamat</td>
        ...
        <tr>
            <td>Password</td>
            <td><input type="password" name="pass" value="<%=pass%>" readonly></td>
        </tr>
        <tr>
            <td>Email</td>
